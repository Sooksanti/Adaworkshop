...
var oClient = Stomp.client('ws://localhost:15674/ws');

var on_connect = function() {
    console.log('connected');
    var msg = 'Hello world';

    oClient.send('/queue/Queues_03', { "content-type": "text/plain" }, msg);
    oClient.subscribe("/queue/Queues_03", function (res){
        console.log(res.body);
        // if(res.body == 'Hello world'){
        //     oClient.send('/queue/Queues_02', {}, 'Hello');
        // }
    });
};
...
oClient.connect('guest', 'guest', on_connect, on_error, 'Group_01');
</script> -->
<h1>Rabbitmq Test</h1>
<div id="chat"></div>
